                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="updatebook.php?idbook=<?php echo $rec['idbook']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal<?php echo $rec['idbook']; ?>"><i class="fas fa-trash"></i> Delete</a>
                            </td>
                        </tr>
