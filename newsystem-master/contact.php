...
<html lang="en">
<head>
    <title>Contact Us - Easy Book</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
  ...
  <?php endif; ?>
    ...
    <div class="contact-header">
        <h1>Contact Us</h1>
        <p>Have a question? Feel free to reach out to us using the form below or via <a href="https://wa.me/your-whatsapp-number" target="_blank">WhatsApp</a>.</p>
    </div>
    ...
    <div class="contact-form-container">
        <form action="process_contact_form.php" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="comment" name="comment" placeholder="Write your message" required></textarea>
            </div>
